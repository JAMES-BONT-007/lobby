    ...
    function lobbychk() {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                var onlineAcc = JSON.parse(xhr.responseText);
                var onlineAccText = onlineAcc.join('<br>');
                document.getElementById("online").innerHTML = onlineAccText;
            }
        };

        xhr.open('POST', 'onlineskrypt.php', true);
